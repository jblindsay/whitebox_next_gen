wbw_build_session <- function(floating_license_id = NULL,
  ...
  session$compute_network_accessibility <- function(input,
                                                    ...
                                                    edge_cost_field = NULL,
                                                    max_snap_distance = NULL,
                                                    node_cost_points = NULL,
                                                    node_cost_field = NULL,
                                                    node_cost_snap_distance = NULL,
    ...
    args <- Filter(
      ...
      list(
        ...
        edge_cost_field = edge_cost_field,
        max_snap_distance = max_snap_distance,
        node_cost_points = node_cost_points,
        node_cost_field = node_cost_field,
        node_cost_snap_distance = node_cost_snap_distance,
  ...
  session$route_shortest_path <- function(input,
                                           start_x,
                                           start_y,
                                           end_x,
                                           end_y,
                                           ...
                                           u_turn_penalty = NULL,
                                           forbid_u_turns = NULL,
                                           forbid_left_turns = NULL,
                                           forbid_right_turns = NULL,
                                           turn_restrictions_csv = NULL,
                                           temporal_cost_profile = NULL,
                                           temporal_edge_id_field = NULL,
                                           departure_time = NULL,
                                           temporal_mode = NULL,
                                           temporal_fallback = NULL,
                                           temporal_profile_report = NULL) {
    args <- Filter(
      Negate(is.null),
      list(
        input = input,
        ...
        max_snap_distance = max_snap_distance,
        edge_cost_field = edge_cost_field,
        one_way_field = one_way_field,
        blocked_field = blocked_field,
        barriers = barriers,
        barrier_snap_distance = barrier_snap_distance,
        node_cost_points = node_cost_points,
        node_cost_field = node_cost_field,
        node_cost_snap_distance = node_cost_snap_distance,
        turn_penalty = turn_penalty,
        u_turn_penalty = u_turn_penalty,
        forbid_u_turns = forbid_u_turns,
        forbid_left_turns = forbid_left_turns,
        forbid_right_turns = forbid_right_turns,
        turn_restrictions_csv = turn_restrictions_csv,
        temporal_cost_profile = temporal_cost_profile,
        temporal_edge_id_field = temporal_edge_id_field,
        departure_time = departure_time,
        temporal_mode = temporal_mode,
        temporal_fallback = temporal_fallback,
        temporal_profile_report = temporal_profile_report
      )
    )
    session$run_tool("shortest_path_network", args)
  }

  session$delineate_network_service_area <- function(input,
                                                      origins,
                                                      output,
                                                      max_cost,
                                                      snap_tolerance = NULL,
                                                      output_mode = NULL,
                                                      polygon_merge_origins = NULL,
                                                      snapped_origins_output = NULL,
                                                      cost_method = NULL,
                                                      edge_cost_field = NULL,
                                                      mode_field = NULL,
                                                      default_mode_speed = NULL,
                                                      mode_speed_overrides = NULL,
                                                      allowed_modes = NULL,
                                                      one_way_field = NULL,
                                                      blocked_field = NULL,
    ...
    args <- Filter(
      ...
      list(
        ...
        polygon_merge_origins = polygon_merge_origins,
        snapped_origins_output = snapped_origins_output,
        cost_method = cost_method,
        edge_cost_field = edge_cost_field,
        mode_field = mode_field,
        default_mode_speed = default_mode_speed,
        mode_speed_overrides = mode_speed_overrides,
        allowed_modes = allowed_modes,
        one_way_field = one_way_field,
        blocked_field = blocked_field,
    ...
    session$run_tool("network_service_area", args)
  }

  session$route_to_closest_facility <- function(input,
                                                 incidents,
                                                 facilities,
                                                 output,
                                                 snap_tolerance = NULL,
    ...
    session$run_tool("closest_facility_network", args)
  }

  session$compute_od_cost_matrix <- function(input,
                                              origins,
                                              destinations,
                                              output,
                                              snap_tolerance = NULL,
    ...
    session$run_tool("network_od_cost_matrix", args)
  }

  session$solve_location_allocation <- function(input,
                                                 demand_points,
                                                 facilities,
                                                 facility_count,
                                                 output,
                                                 solver_mode = NULL,
                                                 demand_weight_field = NULL,
                                                 facility_capacity_field = NULL,
                                                 required_facility_field = NULL,
                                                 forbidden_facility_field = NULL,
                                                 snap_tolerance = NULL,
                                                 max_snap_distance = NULL,
                                                 edge_cost_field = NULL,
                                                 one_way_field = NULL,
    ...
    args <- Filter(
      ...
      list(
        ...
        demand_weight_field = demand_weight_field,
        facility_capacity_field = facility_capacity_field,
    ...
    session$run_tool("location_allocation_network", args)
  }
